...
pub struct ProjectMetadata {
    ...
    pub enable_content_trust: String,
    ...
    /// "true", "false".
    pub auto_sbom_generation: String,
    ...
    pub reuse_sys_cve_allowlist: String,
